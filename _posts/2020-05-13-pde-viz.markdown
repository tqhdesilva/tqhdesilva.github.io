...
but maybe that's because I don't have too much Julia experience.
...
### Heat Equation
The heat equation in 1D is most commonly used to model
...
how things diffuse. It can also be used to model how
